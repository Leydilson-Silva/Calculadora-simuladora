...
---- Atualiza a tabela simulacao_calculadora_juros SETANDO o valor_inicial igual à 50 mil ONDE a coluna id_simulacao seja igual à 1
--UPDATE simulacao_calculadora_juros SET valor_inicial = 50000 WHERE id_simulacao = 1
